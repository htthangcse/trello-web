          ...
          <Box sx={{ 
            ...
            <Box sx={{ 
              ...
              maxHeight: (theme) => `calc(
                ${theme.trello.boadrContentHeight} -
                ${theme.spacing(5)} -
              ...
              <Card sx={{
                ...
                <CardMedia
                  sx={{ height: 140 }}
                  image="https://caodang.fpt.edu.vn/wp-content/uploads/1552622453522_640.jpg"
                  title="green iguana"
                />
                <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 }}}>
                  <Typography>TienThangDev MERN STACK</Typography>
                </CardContent>
              ...
              <Card sx={{
                cursor: 'pointer',
                boxShadow: '0 1px 1px rfba(0, 0, 0, 0.2)',
                overflow: 'unset',
              }}>
                <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 }}}>
                  <Typography >
